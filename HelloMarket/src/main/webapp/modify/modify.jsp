...
<head>
<meta charSet="utf-8" />
<title>상품 수정 | 헬로마켓 - 100% 안전한 중고거래 장터</title>
<meta name="viewport"
...
<body>
	...
	<div id="__next" style="height: auto !important;">
		<div class="mobile_banner">
			<div class="mobile_banner_wrapper">
				<img alt="앱으로하기 로고"
		...
		<header class="">
			...
			<section class="header_top">
				<div class="header_logo header_logo_s">
					<div class="log_box">
						<img src="../img/MarketMain.png"
							class="logo" alt="안녕마켓"><img
							src="https://ccimage.hellomarket.com/web/2020/common/img_title_logo.png"
							class="mobile_logo" alt="안녕마켓"></a>
					</div>
					<%
						if (userId == null) {
					%>
					<div class="btn_box">
						...
						</a><a class="btn_signup_box"><button class="signup_btn">
								<a href="../join/signup.html">회원가입</a>
							</button></a><a href="/msearch">
					...
					<div class="btn_box">
						<div class="nick">
							<img
								...
								width="36" height="36" alt="n15979427의 프로필 사진"
								class="profile_img"><span class="nick_title">n15979427님</span>
						</div>
						<div class="notification_box">
							<a href="https://account.hellomarket.com/messages"
								...
								alt="채팅 아이콘" class="chat">
								<div class="chat_cnt">4</div> </a><a
								href="https://account.hellomarket.com/alarms" target="_blank"><img
								src="https://ccimage.hellomarket.com/web/2019/common/btn_title_notification.png"
								alt="알림목록 아이콘" class="alram">
								<div class="alram_cnt">3</div> </a>
						</div>
					</div>
					<%
						}
						...
						<div class="gnb_my_lyr test_type">
							<a href="/m/level.hm">
								<div class="gnb_my_member_level">
									<img class="gnb_my_member_level_img"
										src="https://ccimage.hellomarket.com/web/2019/member/img_level_1_x2.png"
										alt="뱃지 이미지">
									<div>
										<span class="level_description">나의등급</span><span
											class="level_description_name">화이트</span>
									</div>
								</div>
							</a>
							<ul class="gnb_my_list">
								<a href="/s/@15979427?type=item">
									<li class="gnb_my_list_first">내상점</li>
								</a>
								<a href="hellopay.html">
									<li>헬로페이 거래내역</li>
								</a>
								<a href="coupon.html">
									<li>할인쿠폰</li>
				...
				<div class="header_wrapper">
					<div>
						<div class="btn_box header_wrapper_sub" id="open_cat">
							<input type="checkbox" class="cat_checkbox chkbox1"> <i
								class="arrow"></i> <span for="cat_checkbox" class="selectbox">카테고리</span>
								...
								<div class="cat_list_box left_slidein">
									<div class="mobile_login_wrapper">
										<div class="btn_close_wrapper">
											...
											<button type="button" class="btn_close" for="btnClose">닫기</button>
										</div>
										<div class="member_info">
											<a class="nick" href="/s/@15979427?tab=item">
									...
									<div class="mobile_nav">
										...
										<ul class="cat_list mobile_cat_list">
											...
											<li class="category"><a class="cat_link mobile_cat_link"
												href="/m/wallet/history"><span class="category_text">전자지갑
														· 결제관리</span></a></li>
											<li class="category"><a class="cat_link mobile_cat_link"
												href="/m/order/auto/sales/list.hm"><span
										...
										<ul class="mobile mobile_sub_category">
											...
											<li><a href="../ad/index.html" target="_blank"
												rel="noopener noreferrer">광고센터</a><i
												class="arrow right_arrow"></i></li>
										</ul>
					...
					<div class="sellimg_sub_box header_wrapper_sub">
						<div class="selling_bot">
							<img src="../img/ico_sell_camera_x2.png" alt="판매하기 이미지"
								class="selling_bot_img"><span class="selling_bot_text">판매하기</span>
						</div>
					</div>
					<div class="link_box header_wrapper_sub">
						<ul>
							<li><a
								href="/community/list.hm?category=DAC0002&amp;status=begin">이벤트</a></li>
						...
						<form method="post" action="modify_ok.jsp"
							...
							<div class="regist_box">
								<div class="description">
									<dl id="mainDiv">
										<dt>
											<label style="color: #333333">거래방법</label>
										</dt>
										<dd>
											<div class="hellopay_box_area">
												<!--일단 얘는 이름 맞는거 같은데   -->
												<ul>
													<li class=""><input type="checkbox" id="deal_m"
														name="deal_m1" value="헬로페이">헬로페이</li>
													<li><input type="checkbox" id="deal_m" name="deal_m2"
														value="직거래">직거래</li>
												</ul>
											</div>
											<div class="hellopay_direct_notice">
												<span class="normal_notice">헬로페이만 선택 후 등록시 노출, 할인 혜택
													지원으로 빠른 판매를 도와드립니다.</span>
											</div>
										</dd>
									</dl>
									<dl class="regist_image_dl" id="registImage">
										<dt>
											<label style="color: #333333">상품사진</label><span
												class="photo_max">* 최대 3장</span>
										</dt>
										<dd>
											<ul class="image_list">
												<li>
													<div class="up_img_box" id="">
														<input type="file" id="fileflow01" name="fileflow01" />
														<!--  얘도 이름 맞는데 -->
														<input type="hidden" id="p_image1_orig_name"
															name="p_image1_orig_name" />
														<!--  얘도 이름 맞는데 -->

														<img
															src="https://ccimage.hellomarket.com/web/2018/auto/img_car_pic_basic.png"
															id="img_first" class="item_img" alt="상품 등록 이미지" />
													</div>
												</li>
											</ul>
											...
											<div class="up_img_description">
												<span class="up_img_description_title">* 첫번째 사진은 직접
													촬영한 상품 사진을 등록해주세요.</span><img
													src="https://ccimage.hellomarket.com/web/2019/ad/ico_question_gr_60x60.png"
													alt="물음표이미지" />
												<div class="up_img_hover">
													<span>판매자의 상품 보유 유무와 실물 상태 확인을 위해 직접 촬영한 실제 상품 사진을
														첫번째 이미지로 첨부해주시기 바랍니다.</span><span class="img_hover_margin">상품
														첫번째 이미지에 실제 사진이 첨부되지 않은 경우, 사전안내 없이 수정 또는 삭제될 수 있습니다.</span><span
											...
											<div class="box_option box_area watermark_box_area">
												<div class="can_barter_check">
													...
													<label
														class="feature_option feature_option_checkbox no_feature_option"
														id="reset">이미지리셋</label>
												</div>
									...
									<dl id="title">
										<dt>
											<label style="color: #333333">제목</label>
										</dt>
										<dd>
											<input type="text" class="title_input"
												placeholder="상품 제목을 입력하세요" value="" name="p_title" />
											<!-- 이거도 이름 맞고 -->
									...
									<dl id="category">
										<dt>
											...
											<label style="color: #333333">카테고리</label>
										</dt>
										<!-- 뭐야 이것도 맞는데 -->
										<dd>
									...
									<dl id="content">
										<dt>
											<label style="color: #333333">상품설명</label>
										</dt>
										<dd>
...
- 구매정보(구매일시, 구매시 가격)
- 상품 정보(사이즈, 색상, 브랜드 등)
- 상품 사용감(스크래치, 고장, 수리 여부 등)"
												name="p_description" wrap="hard"></textarea>
										</dd>
										<!-- 이거도 맞는데 -->
									</dl>
									<dl>
											...
											<ul class="item_status_list">
												<li class="item_status">
													...
													<div style="font-size: 13px" class="text">
														<input type="radio" id="p_status" name="p_status1"
															value="새상품" checked>새상품
													</div>
												...
												<li class="item_status">
													...
													<div style="font-size: 12px" class="text">
														<input type="radio" id="p_status" name="p_status2"
															value="중고">중고
													</div>
									...
									<dl class="sell_method_box">
										<dt>
											<label id="price" style="color: #333333">거래종류</label>
										</dt>
										<dd>
												...
												<ul class="item_status_list">
													<li>
														<div class="text_wrapper click text_first">
															<input type="radio" id="trade_kind" name="p_trade_kind"
																value="판매">판매
														</div>
													</li>
													<li>
										...
										<dd>
											<div class="box_price box_area">
												<input type="text" placeholder="판매희망 가격을 입력하세요"
													class="sell_type_input" name="p_price"><span
												...
												<dd>
													<div class="box_option box_area check_box_area">
														<div>
															<label
																class="feature_option feature_option_checkbox no_feature_option">
																<input type="radio" name="p_delivery" value="무료배송">무료배송
															</label>
														</div>

														<div class="can_barter_check can_delivery_check">
															<label
																class="feature_option feature_option_checkbox no_feature_option"><input
																type="radio" name="p_exchange" value="교환신청">교환신청</label>
														</div>
													</div>
												</dd>
											</dl>
									...
									<dl>
										...
										<dd class="map_box">
											<input type="text"
												class="my_location_input item_location_input"
												placeholder="위치 선택" readonly="readonly" value=""
												name="p_transac_loc" id="sample6_address" /> <input
												type="hidden" name="" id="sample6_extraAddress" /> <input
												type="hidden" name="" id="sample6_detailAddress" /> <input
												type="hidden" name="" id="sample6_postcode" />
							...
							<div>
								<div class="item_notice">
									...
									<div class="text_bottom">비정상적인 상품을 등록하거나, 헬로포인트 사용금지
										거래(상품권)에 속하는 상품을 해당 카테고리가 아닌 잘못된 카테고리에 등록할 경우 그 정도에 따라 경고,
										출금요청 취소, 지급된 헬로포인트 전액 소멸, 계정제재 등의 책임을 물을 수 있음을 알려드립니다.</div>
								</div>
								<div class="item_submit_box">
									<div class="item_area_submit_box">
										<a href="/"><button class="btn_item_cancel" type="button">취소</button></a>
										<button class="btn_item_mobile_cancel" type="button">삭제</button>
		...
		<div class="footer">
			<div class="footer_area">
				<div class="footer_top">
					<div class="f_wrapper">
						<ul class="f_left">
							<li><a href="http://company.hellomarket.com"
								class="link_info" target="_blank" rel="noopener noreferrer">Hellomarket
									Inc.</a></li>
						...
						<ul class="f_right">
							...
							<li><a href="https://blog.naver.com/tuckandco"
								target="_blank" rel="noopener noreferrer"><img
					...
					<div class="f_wrapper">
						<div class="footer_wrapper_left">
							...
							<ul class="footer_company_info">
								<li><span>(주)헬로마켓 대표이사 : 이후국 | </span><span>서울특별시
										마포구 와우산로 25길 7 서문빌딩 502호</span></li>
								<li><span>사업자등록번호 : 105-87-56305</span><span>통신판매업신고번호
										: 제2011-서울마포-1010호 <!-- --> <a
										href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=1058756305"
										class="link_info" target="_blank"
										style="text-decoration: underline" rel="noopener noreferrer">사업자정보확인</a>
								</span></li>
								<li><span>헬로페이 문의 : 02-324-4090</span><span>(평일
										10시~16시) | 팩스 : 02-3141-4090</span></li>
								<li><span>일반문의: <!-- --> <a
										href="https://www.hellomarket.com/help/inquiry/form.hm"
										target="_blank" style="text-decoration: underline"
										rel="noopener noreferrer">헬프센터 - 문의</a></span><span> <!-- -->|
										<!-- --> <a
										href="https://www.hellomarket.com/help/inquiry/form.hm?categoryId=IGA0200"
										target="_blank" style="text-decoration: underline"
										rel="noopener noreferrer">제휴문의</a></span></li>
								<br />
								<li><span>(주)헬로마켓은 통신판매중개자로서 거래당사자가 아니며, 판매자가 등록한
										상품정보 및 거래에 대해 (주)헬로마켓은 일체 책임을 지지 않습니다.</span></li>
